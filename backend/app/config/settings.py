...
# DEFAULT_HTML_PATH = DATA_DIR / "input" / "full_student_book.html"
# DEFAULT_CHROMA_DIR = DATA_DIR / "chroma_db"
# DEFAULT_ENCYCLOPEDIA_DIR = DATA_DIR / "encyclopedia"
...
def get_settings() -> AppSettings:
    ...
    cfg_path = base_dir / "app.defaults.toml" # "config" /
    ...
    return AppSettings(
        ...
        # encyclopedia_dir=_resolve_path(root_dir, paths["encyclopedia_dir"]),
