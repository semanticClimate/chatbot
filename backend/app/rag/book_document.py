...
from backend.app.utils.html_sectioning import annotate_html_with_section_ids
...
def package_assets_dir() -> Path:
    """backend.app/assets (book iframe CSS/JS)."""
    return _ASSETS
...
def build_annotated_book_document(settings: AppSettings) -> str:
    ...
    print("BOOK FILE:", html_file)
    # html_file = Path("D:/Aleena/Programming/Internship/#semanticclimate/Chatbot_og_refactored/Chatbot_V1/data/encyclopedia/output/full_student_book_annotated.html")
    print("BOOK FILE:", html_file)
    raw = html_file.read_text(encoding="utf-8")
    print("RAW HAS LINKS:", "ca-encyclopedia-link" in raw)
    ...
    print("HAS LINKS:", has_encyclopedia_links)
