...
- Scope: tidy and document `backend.app/zoom_daily_summary.py` with focus on anonymization quality and safer summarization behavior.
...
- `backend.app/zoom_daily_summary.py`
