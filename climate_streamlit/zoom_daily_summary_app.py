...
def main() -> None:
    ...
    if st.button("Generate summary.md", type="primary"):
        ...
        attendees = collect_session_attendees(st.session_state.utterances, alias_map=alias_map)
