...
from data.encyclopedia.cabook_annotate.media_paths import rewrite_media_src_in_tree
from data.encyclopedia.config_loader import load_annotate_settings
...
def test_rewrite_media_src_points_to_input_media(tmp_path):
    ...
    out_html.write_text(
        '<html><body><img src="data/input/media/image1.png" alt="test"></body></html>',
        encoding="utf-8",
    )
...
[paths.input]
book_html = "data/input/full_student_book.html"
book_media_dir = "data/input/media"
encyclopedia_html = "data/input/full_student_book.html"
